...
this.JST = this.JST || {}, this.JST["editProfile.html"] = function(obj) {
    ...
    render: function(a) {
        $("#body-container").hide(), $("#view-container").show(), $("#modal_container").modal("hide"), 
        this.$el.html(this.template()), this.$table = this.$el.find(".contact-table"), this.$btSend = this.$el.find(".send"), 
        ...
        this.$event_name = this.$el.find(".event-name"), this.$event_date = this.$el.find(".event-date"), 
        this.$btSend = this.$el.find(".send"), this.i = 0;
        var b = $("a .active");
        ...
        }), null != a.title && this.$event_name.val(a.title), null != a.id && this.createFromInvite(a.id), 
        this;
    },
...
InviteView = Backbone.View.extend({
    ...
    render: function(a) {
        ...
        }), this.$el.modal("show"), this;
    },
    onChildClose: function() {
        null != this.$el && this.$el.modal("hide"), Backbone.history.navigate("", !0);
    }
