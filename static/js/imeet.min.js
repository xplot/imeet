...
this["JST"]["contact_item.html"] = function(obj) {
    ...
    with (obj) {
        __p += '<div class="editable col-md-2">\n    ' + __e(name) + '\n</div>\n<div class="col-md-2">' + __e(email) + '</div>\n<div class="col-md-2">' + __e(phone) + '</div>\n<div class="col-md-1 update-column">\n    <a class="update-contact" href="api/contacts/' + __e(unique_id) + '"><i class="fa-pen fa-1_2x"></i></a>\n    <a class="delete-contact" href="api/contacts/' + __e(unique_id) + '"><i class="fa-delete-garbage-streamline fa-1_2x"></i></a>\n</div>';
    }
    return __p;
};
