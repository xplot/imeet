...
this["JST"]["group-item.html"] = function(obj) {
    ...
    with (obj) {
        ...
        __p += '\n<div class="panel group panel-default ' + __e(panel_class) + '" data-id="' + __e(unique_id) + '" id="panel_' + __e(unique_id) + '">\n    <div class="panel-heading " role="tab" id="heading_' + __e(unique_id) + '" data-id="' + __e(unique_id) + '">\n        <h4 class="panel-title" data-id="' + __e(unique_id) + '">\n            <a class="collapsed" data-toggle="collapse" data-parent="#groups_accordion" href="#collapse_' + __e(unique_id) + '"\n               aria-expanded="false" aria-controls="collapse_' + __e(unique_id) + '" data-id="' + __e(unique_id) + '">\n                <div data-id="' + __e(unique_id) + '">\n                    ' + __e(cut(name)) + '<i style="float: right" class="fa fa-angle-down fa-1_5x"></i>\n                </div>\n            </a>\n      </h4>\n    </div>\n    <div id="collapse_' + __e(unique_id) + '" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne" >\n        <div class="panel-body group group-box" data-id="' + __e(unique_id) + '">\n            Drop Contacts here!!!\n        </div>\n    </div>\n</div>\n\n';
    }
    return __p;
};
...
GroupListView = Backbone.View.extend({
    ...
    render: function(a) {
        ...
        if (groupList.length > 0) this.groupList.forEach(function(a) {
            ...
            b.$el.append("You have no groups. Create one!");
        }
