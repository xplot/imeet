    ...
    render: function(a) {
        ...
        $.ajax({
            ...
            success: function(a) {
                ...
                e.html(a.title);
                f.html(a.start);
                var h = "                    <div class='row contact-row small-margin {3}' data-contact='{0},{1},{2}' >                             <div class='col-sm-2'> {0} </div>                             <div class='col-sm-2'>  {1} </div>                             <div class='col-sm-2'> {2}</div>                     </div> ";
                a.contacts.forEach(function(a) {
                    var b = "";
                    if (a.sms_response != null || a.voice_reponse != null || a.email_response != null) b = "alert-success";
                    g.append(h.format(a.name || "N/A", a.email || "", a.phone || "", b));
                });
                b(a.comments);
