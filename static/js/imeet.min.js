...
this["JST"]["invite_search.html"] = function(obj) {
    ...
    with (obj) {
        ...
        _.each(invites, function(item) {
            __p += '\n                <div class="col-md-3 invite-card">\n                    <div class="row title"><a href="#" class="invite-link" data-id=\'' + __e(item.unique_id) + "'>" + __e(item.title) + '</a> </div>\n                    <div class="row date">' + __e(item.start) + ' </div>\n                    <div class="row description">' + __e(item.description) + " </div>\n                    <div class=\"row actions\">\n                        <button type='button' class='btn btn-success btn-duplicate' data-id='" + __e(item.unique_id) + "'>DUPLICATE</button>\n                        <button type='button' class='btn btn-warning btn-edit' data-id='" + __e(item.unique_id) + "'>EDIT</button>\n                        <button type='button' class='btn btn-danger btn-cancel' data-id='" + __e(item.unique_id) + "'>CANCEL</button>\n                    </div>\n                </div>\n        ";
        });
        __p += "\n    </div>\n</div>\n\n";
    }
    return __p;
