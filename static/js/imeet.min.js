...
CreateView = Backbone.View.extend({
    el: "#header-container",
    new_contact_string: "            <div id='contact_{2}'  class='row contact-row equidistant' data-contact='{0};{1};{2}'>                <div class='col-md-4 col-md-offset-2'> {0}</div>                <div class='col-md-3'> {1}</div>                <div class='col-md-1'>                     <button type='button' class='btn btn-danger remove-contact form-control' data-row='{2}'>-</button>                              </div>             </div>",
    reportView: null,
    ...
    removeContact: function(a) {
        ...
        (null == c || 0 == c.length) && this.$btSend.attr("disabled", "disabled"), this.removeContactByIndex(parseInt(b.split("_")[1]));
    },
