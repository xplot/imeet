...
InviteView = Backbone.View.extend({
    ...
    contactToString: function(a) {
        var b = "<div>{0} {1} {2} <div style='width: 50px;float: left' class='{3}'>YES</div></div>";
        var c = a.sms_response != null || a.voice_response != null || a.email_response != null || false;
        var d = "hidden";
        if (c) d = "confirmed";
        return b.format(a.name || "", a.phone || "", a.email || "", d);
    },
    render: function(a) {
