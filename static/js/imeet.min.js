...
var palette = [ "red", "#455a64", "#03a9f4", "#0E2A97", "#00ACFF", "#FF246C", "#75B83B" ];
...
InlineInviteView = Backbone.View.extend({
    ...
    render: function() {
        ...
        this.$el.append(a.render()), $("#header").css("background-color", palette[Math.floor(Math.random() * palette.length)]);
    },
    createNew: function() {
