...
CreateView = SimpleView.extend({
    ...
    share_on_facebook_auth: function() {
        window.open(api.url + "/social_sharing/facebook", "_blank", "toolbar=no, scrollbars=no, resizable=yes, top=500, left=500, width=400, height=400");
    },
    plugins: function() {
