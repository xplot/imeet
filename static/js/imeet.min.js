...
ContactsView = SimpleView.extend({
    ...
    deleteContact: function(a) {
        ...
        $.ajax({
            url: a.target.parentNode.attributes.href.value,
            type: "DELETE",
            contentType: "application/json",
            cache: false,
            success: function(b) {
    ...
    saveContact: function() {
        ...
        $.ajax({
            ...
            success: function(d) {
                ...
                c.$el.html("");
                a.contact_id = d.unique_id;
                b.append(new ContactItemView().render(a).el);
...
ContactItemView = SimpleView.extend({
    tagName: "tr",
    render: function(a) {
        this.$el.html("<td>" + a.name + "</td><td>" + a.email + "</td><td>" + a.phone + "</td><td><a class='update-contact' href='api/contacts/" + a.contact_id + "'><span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></a><a class='delete-contact' href='api/contacts/" + a.contact_id + "'><span class='glyphicon glyphicon-remove' aria-hidden='true'></span></a></td>");
        return this;
    }
});
