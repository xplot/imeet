...
=======
        __p += '<div class="row contact-row" data-id="' + __e(unique_id) + '" draggable="true">\n    <div class="editable col-sm-4 col-xs-8" >\n        ' + __e(name) + '\n    </div>\n    <div class="editable desktop tablet col-sm-4">' + __e(email) + '</div>\n    <div class="editable desktop tablet col-sm-2">' + __e(phone) + '</div>\n    <div class="col-sm-2 col-xs-4 update-column">\n        <a class="editable" href="#"><i class="fa-pen fa-1_2x"></i></a>\n        <a class="delete-contact" href="#"><i data-id="' + __e(unique_id) + '" class="fa-delete-garbage-streamline fa-1_2x"></i></a>\n    </div>\n</div>';
...
var cut = function b(a) {
    if (a.length >= 8) return a.substring(0, 4) + "...";
    return a;
};
...
CreateView = SimpleView.extend({
    ...
    createFromInvite: function(a) {
        ...
        $.ajax({
            ...
            cache: false,
            success: function(a) {
                b.model.attributes.title = a.title;
                b.model.attributes.description = a.description;
                b.model.attributes.start_date = moment(a.start).format("L");
                b.model.attributes.start_time = moment(a.start).format("LT");
                if (a.end) {
    ...
    newContact: function(a) {
        this.$table.prepend(this.new_contact_string.format(a.attributes.name, a.attributes.email + " " + a.attributes.phone, a.attributes.unique_id));
        return false;
    },
...
=======
    ...
    contactStartDrag: function(a) {
        var b = $(a.target);
        var c = b.data("id");
        a.originalEvent.dataTransfer.setData("contact_id", c);
    },
...
>>>>>>> 8cc36de... Contacts and Groups
    ...
    navigateToAddContact: function(a) {
        a.preventDefault();
        Backbone.history.navigate(a.target.attributes.href.value, true);
    },
<<<<<<< HEAD
...
ReportView = Backbone.View.extend({
    ...
    new_contact_string: "            <li id='{2}' class='contact-row' data-contact='{0};{1}'>                {0} &nbsp; {1}             </li>",
    initialize: function(a) {
        this.options = a || {};
    ...
    addContact: function(a) {
        this.$report_table.append(this.new_contact_string.format(a.attributes.name, a.attributes.email + " " + a.attributes.phone, a.attributes.unique_id));
    },
    removeContact: function(a) {
        this.$report_table.find("#" + a.attributes.unique_id).remove();
    }
});
