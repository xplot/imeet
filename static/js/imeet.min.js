...
CreateView = SimpleView.extend({
    ...
    inviteSubmitted: function(a, b) {
        Backbone.history.navigate("view/" + b, true);
    },
...
InviteView = SimpleView.extend({
    ...
    render: function(a) {
        ...
        d.render(new InviteModel(a.invite));
        $.ajax({
...
AdminInviteView = SimpleView.extend({
    ...
    render: function(a) {
        ...
        this.$el.html(this.template(b));
        var c = new InviteAttendeesView({
            el: "#invite-attendees"
        });
        var d = new InviteHeaderView({
            el: "#invite-header"
        });
        var e = new InviteEditDetailsView({
            el: "#invite-edit"
        });
        c.render({
