...
this.JST = this.JST || {}, this.JST["editProfile.html"] = function(obj) {
    ...
    obj || (obj = {});
    var __p = "";
    with (_.escape, obj) __p += "<div class=\"row equidistant invite_report\">\n    <div class=\"col-xs-12 col-md-8 col-md-offset-2\">\n        <div class=\"panel panel-primary\">\n         <div class=\"panel-heading\">\n                <div class=\"row\">\n                     <div class='event-name pull-left col-xs-6 col-md-8'></div>\n                     <div class='text-right col-xs-6 col-md-4'>\n                         <div>\n                             <div class='label_title'>From</div>\n                             <div class='event-start-date' style='float:left'></div>\n                         </div>\n                         <div class='clearfix'></div>\n                         <div>\n                             <div class='label_title'>To</div>\n                             <div class='event-end-date'  style='float:left'></div>\n                         </div>\n                     </div>\n                </div>\n             </div>\n         </div>\n\n          <div class=\"panel-body\">\n            <div class='col-xs-12 col-md-12 event-description'>\n            </div>\n\n            <div class='col-xs-12 col-md-8 small-margin-top'>\n                <label class='label_title'>Where:</label>\n                <div class='pull-left'>\n                    <div class='event-address-street'></div>\n                    <div class='event-address-suite'></div>\n                    <div class='event-address-city'></div>\n                    <div class='event-address-state'></div>\n                    <div class='event-address-zip'></div>\n                </div>\n            </div>\n          </div>\n        </div>\n    </div>\n</div>\n";
    return __p;
    ...
    render: function(a) {
        this.bindings = inviteBindings, $("#body-container").hide(), $("#view-container").show(), 
        $("#modal_container").modal("hide"), this.$el.html(this.template()), this.$table = this.$el.find(".contact-table"), 
        this.$btSend = this.$el.find(".send"), this.$contactForm = this.$el.find("#newContactForm"), 
        this.$inviteForm = this.$el.find("#newInviteForm"), this.$new_name = this.$el.find(".new-contact-name"), 
        this.$new_phone = this.$el.find(".new-contact-phone"), this.$event_name = this.$el.find(".event-name"), 
        this.$event_start_date = this.$el.find(".event-start-date"), this.$event_start_time = this.$el.find(".event-start-time"), 
        this.$event_end_date = this.$el.find(".event-end-date"), this.$event_end_time = this.$el.find(".event-end-time"), 
        this.$btSend = this.$el.find(".send"), this.i = 0, this.$event_start_date.datepicker({}), 
        ...
        this.$el.panelSnap({
            ...
            onSnapFinish: function(a) {
                var c = a.data("panel");
                b.removeClass("active"), b = $("a[data-panel='" + c + "']"), b.addClass("active");
            },
            onActivate: function() {},
        ...
        }), null != a.id ? this.createFromInvite(a.id) : this.model = new InviteModel(), 
        null != a.title && this.model.set("title", a.title);
        var c = new ReportView({
            model: this.model,
            el: "#reportXXX"
        });
        return c.render(), this.stickit(), this;
    },
    ...
    newContact: function() {
        if (validator.validateItem(this.$new_phone)) {
            ...
            return this.$new_name.val(""), this.$new_phone.val(""), this.$table.append(a), this.i++, 
            this.$btSend.removeAttr("disabled"), !1;
        }
    },
...
ReportView = Backbone.View.extend({
    ...
    initialize: function(a) {
        this.options = a || {}, console.log(this.options.model), this.model = this.options.model;
    },
