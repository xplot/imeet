...
this["JST"]["contact_item_edit.html"] = function(obj) {
    ...
    var __t, __p = "", __e = _.escape;
    with (obj) {
        __p += '<div data-id="' + __e(unique_id) + '">\n<div class="editable col-md-2">\n    <input id="edit-name" value="' + __e(name) + '">\n</div>\n<div class="col-md-2">\n<input id="edit-email" value="' + __e(email) + '">\n</div>\n<div class="col-md-2">\n    <input id="edit-phone" value="' + __e(phone) + '">\n\n</div>\n<div class="col-md-1 update-column">\n    <a href="#" class="finish-edit">OK</a>\n</div>\n</div>';
    }
    return __p;
};
