...
CreateView = SimpleView.extend({
    el: "#header-container",
    new_contact_string: "            <div id='{2}'  class='contact-row equidistant' data-contact='{0};{1}'>                <div class='col-md-4 col-md-offset-2'> {0}</div>                <div class='col-md-3'> {1}</div>                <div class='col-md-1'>                     <button type='button' class='btn btn-danger remove-contact form-control' data-rowid='{2}'>-</button>                              </div>             </div>",
    reportView: null,
    initialize: function(a) {
        this.options = a || {};
    },
        ...
        $.ajax({
            ...
            success: function(a) {
                ...
                a.contacts.forEach(function(a) {
                    b.model.attributes.contacts.add(new Contact({
                        unique_id: guid(),
                        name: a.name,
                        email: a.email,
                        phone: a.phone
    ...
    newContact_DOM: function(a) {
        this.$new_name.val("");
        this.$new_phone.val("");
        this.$table.append(this.new_contact_string.format(a.attributes.name, a.attributes.email + " " + a.attributes.phone, a.attributes.unique_id));
    },
