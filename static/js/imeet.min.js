    ...
    render: function(a) {
        ...
        $.ajax({
            ...
            success: function(a) {
                ...
                b.html(a.title);
                c.html(a.start);
                var e = "                    <div class='row contact-row small-margin {3}' data-contact='{0},{1},{2}' >                             <div class='col-sm-2'> {0} </div>                             <div class='col-sm-2'>  {1} </div>                             <div class='col-sm-2'> {2}</div>                     </div> ";
                a.contacts.forEach(function(a) {
                    var b = "";
                    if (a.sms_response != null || a.voice_reponse != null || a.email_response != null) b = "alert-success";
                    d.append(e.format(a.name || "N/A", a.email || "", a.phone || "", b));
                });
                var f = $(".invite-comments");
                a.comments.forEach(function(a) {
                    f.append('<li id="{0}" class="invite-comment-row">                                                     <span class="pull-left invite-comment-author">{1}:</span>                                                     {2}                                                   </li>'.format(a.id, a.author, a.comment));
                });
            }
        });
    },
