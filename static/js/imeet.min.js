...
GroupListView = Backbone.View.extend({
    ...
    addContactToGroup: function(a, b) {
        $.ajax({
            ...
            contentType: "application/json",
            success: function(c) {
                $("#groupbox_" + b.get("unique_id")).append('<div class="col-md-3 group-contact">' + a.get("name") + "</div>");
            },
            error: function() {
                alert_notification([ {
                    alertType: "danger",
