...
CreateView = Backbone.View.extend({
    ...
    render: function(a) {
        ...
        }), null != a.id ? this.createFromInvite(a.id) : this.model = testModel, null != a.title && this.model.set("title", a.title);
