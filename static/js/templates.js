...
with (obj) {
__p += '    <section data-panel="first" class="container invite top-separator">\n        <div class="row text-center">\n            <h4>Event</h4>\n        </div>\n        <div class="row equidistant">\n            <div class="col-xs-12 col-md-8 col-md-offset-2">\n                <input required type="text" class="form-control event-name valid-before-submit" placeholder="Event" autofocus data-validation="required" >\n            </div>\n        </div>\n\n        <div class="row equidistant">\n            <div class="col-xs-12  col-md-3 col-md-offset-2">\n                <div class="date-group">\n                    <input required type="text" class="date event-start-date valid-before-submit" placeholder="01/01/2000" data-validation="required,date" >\n                    <input required type="int" class="time event-start-time  valid-before-submit" placeholder="00:00 AM" data-validation="required,time" >\n                </div>\n            </div>\n            <div class="col-xs-12 col-md-2 text-center label-text">\n                To\n            </div>\n            <div class="col-xs-12 col-md-3">\n                <div class="date-group">\n                    <input required type="text" class="date event-end-date valid-before-submit" placeholder="01/01/2000" data-validation="date" >\n                    <input required type="text" class="time event-end-time valid-before-submit" placeholder="00:00 AM" data-validation="time" >\n                </div>\n            </div>\n        </div>\n        <div class="row equidistant">\n            <div class="col-xs-12 col-md-8 col-md-offset-2">\n              <textarea class="form-control event-description" rows="6"></textarea>\n            </div>\n        </div>\n    </section>\n\n    <section data-panel="second" class="container">\n        <div class="row text-center">\n            <h4>Where</h4>\n        </div>\n\n        <div class="row equidistant">\n            <div class="col-xs-12 col-md-8 col-md-offset-2">\n                <input type="text" class="form-control event-address" placeholder="Address"  >\n            </div>\n        </div>\n    </section>\n\n    <section data-panel="third" class="container invite">\n\n        <div class="row text-center">\n            <h4>Who is invited?</h4>\n        </div>\n\n        <div class="row equidistant">\n            <div class="col-md-4 col-md-offset-2">\n                <input type="text" class="new-contact-name form-control" placeholder="Name">\n            </div>\n\n            <div class="col-md-3">\n                <input type="text" class="new-contact-phone form-control"\n                    ';
...
this["JST"]["invite_inline_create.html"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
