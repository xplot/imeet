...
class InviteHandler(JsonHandler):
    ...
    def send(self):
        ...
        invite_manager.send(
            invite_template={
                'Url': "http://imeet3-dot-invite-voiceflows.appspot.com/template/default_invite_template.html",

            },
            extra_data={
                'email_response_url': "http://imeet3-dot-invite-voiceflows.appspot.com/template/default_invite_response.html",
            }
        )
